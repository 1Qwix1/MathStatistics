...
for n in n_values:
    for dist_name, dist in distributions.items():
        ...
        results.append([dist_name, n, k, chi2_value, critical_value, hypothesis_result])
...
interval_columns = ["Распределение", "Размер Выборки", "Интервалы", "Интервал", "Наблюдаемое Значение", "Ожидаемое Значение", "Разница"]
